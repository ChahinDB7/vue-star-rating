# Star Rating Component for Vue 3.x (Improved for Nuxt3)

Server Side possible. Orginal code from [Craigh411](https://www.npmjs.com/package/vue-star-rating)
...
A simple, highly customisable star rating component for Vue 3.x
...
`npm install @chahindb7/vue-star-rating`
...
import '@chahindb7/vue-star-rating/style'
```
...
```javascript
<script src="https://unpkg.com/@chahindb7/vue-star-rating@1.0.0/dist/vue-star-rating.umd.js"></script>
````
